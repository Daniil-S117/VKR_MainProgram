...
name = "Подключение камеры для определения показаний прибора"
...
def example():
    ...
    def pick_files_result(e: ft.FilePickerResultEvent):
        ...
        if e.files:
            ...
            for new_image in new_images:
                ...
                processed_image = ft.Image(src_base64=image_string)
    ...
    class Example(ft.Row):
        ...
        # happens when example is removed from the page (when user chooses different control group on the navigation
        # rail)
    ...
    def fill_tabs(images):
        ...
        tabs_icons = [ft.Icons.IMAGE_ROUNDED, ft.Icons.IMAGE_SEARCH_ROUNDED, ft.Icons.SETTINGS,
                      ft.Icons.SPEED_ROUNDED, ft.Icons.NUMBERS_ROUNDED, ft.Icons.ADD_CIRCLE]
    ...
    table_data = [
        ...
        [ft.Text("Отметки на шкале:", size=16), ft.Text("", size=16)],
        [ft.Text("Название изображения:", size=16), ft.Text("", size=16)],
